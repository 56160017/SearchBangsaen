...
public class AddLatLngHotelFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        tvTitle.setCardBackgroundColor(R.color.title_bar_hotel);
        tvNameTitle.setText("เลือกตำแหน่งของโรงแรม");
        ...
        btnSubmitAddmap.setOnClickListener(OnbtnSuccessToAddMapClickListener);
        ivBack.setOnClickListener(OnbtnBackClickListener);
    }
    private View.OnClickListener OnbtnSuccessToAddMapClickListener = new View.OnClickListener() {
        @Override
    ...
    public static Fragment newInstance() {
        return new AddLatLngHotelFragment();
    }
